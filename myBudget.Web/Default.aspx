<%@ Page Language="C#" MasterPageFile="~/Site_main.Master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="myBudget.Web.Default" Title="ระบบบริหารงานบุคลากร มหาวิทยาลัยแม่โจ้" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlcontent_right" runat="server" class="content_right" DefaultButton="ImageButton1">
        <div class="login_panel" style="background: url(images/login_panel.png); width: 364px; height: 243px;">
