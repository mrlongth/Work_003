<%@ Page Language="C#" MasterPageFile="~/Site_list.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="activity_list.aspx.cs" Inherits="myBudget.Web.App_Control.activity.activity_list"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    function changeBudget(e){ 
        myBudget.Web.App_Control.activity.activity_list.GetDataBudget(e.options[e.selectedIndex].value,RetrieveBudget); 
    } 
   ...
   { 
    ...
    function changeProduce(e){ 
        myBudget.Web.App_Control.activity.activity_list.GetDataProduce(e.options[e.selectedIndex].value,RetrieveProduce); 
    } 
