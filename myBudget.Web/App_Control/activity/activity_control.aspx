<%@ Page Language="C#" MasterPageFile="~/Site_popup.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="activity_control.aspx.cs" Inherits="myBudget.Web.App_Control.activity.activity_control" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    function changeBudget(e){ 
        myBudget.Web.App_Control.activity.activity_control.GetDataBudget(e.options[e.selectedIndex].value,RetrieveBudget); 
    } 
   ...
   { 
    ...
    function changeProduce(e){ 
        myBudget.Web.App_Control.activity.activity_control.GetDataProduce(e.options[e.selectedIndex].value,RetrieveProduce); 
    } 
    </script>--%>
