<%@ Page Language="C#" MasterPageFile="~/Site_list.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="unit_list.aspx.cs" Inherits="myBudget.Web.App_Control.unit.unit_list"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    function changeDirector(e){ 
        myBudget.Web.App_Control.unit.unit_list.GetDataDirector(e.options[e.selectedIndex].value,RetrieveDTCallBack); 
    } 
