<%@ Page Language="C#" MasterPageFile="~/Site_popup.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="unit_control.aspx.cs" Inherits="myBudget.Web.App_Control.unit.unit_control" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function changeDirector(e) {
            myBudget.Web.App_Control.unit.unit_control.GetDataDirector(e.options[e.selectedIndex].value, RetrieveDTCallBack);
        }
