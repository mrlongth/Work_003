<%@ Page Language="C#" MasterPageFile="~/Site_popup.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="produce_control.aspx.cs" Inherits="myBudget.Web.App_Control.produce.produce_control" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    function changeBudget(e){ 
        myBudget.Web.App_Control.produce.produce_control.GetDataBudget(e.options[e.selectedIndex].value,RetrieveDTCallBack); 
    } 
