<%@ Page Language="C#" MasterPageFile="~/Site_list.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="produce_list.aspx.cs" Inherits="myBudget.Web.App_Control.produce.produce_list"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    function changeBudget(e){ 
        myBudget.Web.App_Control.produce.produce_list.GetDataBudget(e.options[e.selectedIndex].value,RetrieveDTCallBack); 
    } 
