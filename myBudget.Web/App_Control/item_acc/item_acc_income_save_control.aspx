<%@ Page Language="C#" MasterPageFile="~/Site_popup.Master"  ValidateRequest="true"
    AutoEventWireup="true" CodeBehind="item_acc_income_save_control.aspx.cs" Inherits="myBudget.Web.App_Control.item_acc_income_save.item_acc_income_save_control" %>
